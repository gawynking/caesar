 ...
 * 定制SQL格式化工具
 */
public class DruidSQLOutputVisitor extends HiveOutputVisitor {
     ...
     * @param appender
     */
    public DruidSQLOutputVisitor(Appendable appender) {
        super(appender);
    }
     ...
     * @param dbType
     */
    public DruidSQLOutputVisitor(Appendable appender, DbType dbType) {
     ...
     * @param parameterized
     */
    public DruidSQLOutputVisitor(Appendable appender, boolean parameterized) {
