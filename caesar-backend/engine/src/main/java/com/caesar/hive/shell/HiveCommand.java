...
public class HiveCommand extends ShellTask implements Command {

    private HiveReceiver receiver;
    private ScriptInfo scriptInfo;

    public HiveCommand(ScriptInfo scriptInfo) {
        this.receiver = new HiveReceiver(this);
    ...
    public ExecutionResult<ShellTask> execute() {
        this.buildCommand();
        return receiver.runHiveQuery();
    }

    @Override
    public ExecutionResult<ShellTask> cancel() {
        return receiver.cancelHiveQuery();
    }
