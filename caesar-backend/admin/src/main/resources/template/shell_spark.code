...
#  --executor-cores 1 \
#  --num-executors 2 \
#  --class com.caesar.spark.sql.SparkSqlSubmit \
#  --conf spark.sql.param.start_date=${start_date} \
#  --conf spark.sql.param.end_date=${end_date} \
#  /opt/caesar/lib/spark-plugin.jar \
#  ${sql_file}
